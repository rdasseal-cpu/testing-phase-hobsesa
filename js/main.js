...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            // Valid! Form will natively POST to the hidden iframe target
            ...
            const handleSuccess = () => {
                ...
                if (successFeedback) {
                    successFeedback.textContent = `Thank you, ${senderName}! Your message has been sent successfully to HOBSESA.`;
            ...
            // Trigger completion when hidden iframe loads response
            if (contactIframe) {
                const onIframeLoad = () => {
                    handleSuccess();
                    contactIframe.removeEventListener('load', onIframeLoad);
                };
                contactIframe.addEventListener('load', onIframeLoad);
            }
